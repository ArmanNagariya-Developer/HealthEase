...
<nav class="app-header navbar navbar-expand bg-body">
  ...
  <div class="container-fluid">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-md-block"><a href="#" class="nav-link">Users</a></li>
      <li class="nav-item d-none d-md-block"><a href="#" class="nav-link">Events</a></li>
    </ul>
      ...
      <li class="nav-item dropdown user-menu">
        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
          <img
            ...
            alt="User Image"
          />
          {{-- <span class="d-none d-md-inline">{{Auth::guard("admin")->user()->name ?? "Guest"}}</span> --}}
        </a>
